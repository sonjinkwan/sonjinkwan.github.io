	...
	<table class="table">
		<tbody class="table_body">
			<tr class="reg_row">
				...
				<td class="reg_input"><input type="text" name="userid" size="30" class="reg-control" value="${data.userid}" readonly /></td>
			</tr>
			<tr class="reg_row">
				<th class="reg_lb"><label for="passwd">비밀번호</label></th>
				<td class="reg_input"><input type="text" name="passwd" size="30" class="reg-control" value="${data.passwd}" /></td>
			</tr>
			<tr class="reg_row">
				<th class="reg_lb"><label for="name">이름</label></th>
				<td class="reg_input"><input type="text" name="name" size="30" class="reg-control" value="${data.name}" /></td>
			</tr>
			<tr class="reg_row">
				<th class="reg_lb"><label for="email">이메일</label></th>
				<td class="reg_input"><input type="text" name="email" size="30" class="reg-control" value="${data.email}" /></td>
			</tr>
			<tr class="reg_row">
