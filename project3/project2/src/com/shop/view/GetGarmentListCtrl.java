...
@WebServlet("/GetGarmentListCtrl")
public class GetGarmentListCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/garment/getGarmentList.jsp");
